...
if cookielogin:
	...
	with open("../html/institution.html",mode="r",encoding="utf-8") as html:
		lines = html.readlines()
	lines.insert(19, "<li><a>ログイン中</a></li>")
	with open("../html/institution.html",mode="w",encoding="utf-8") as tmp:
		tmp.writelines(lines)
	with open("../html/institution.html",mode="r",encoding="utf-8") as tmp:
